...
public class DeviceUtil {
    ...
    public static int dp2px(float pDipValue) {
        return (int) dp2px(BaseApplication.get(), pDipValue);
    }
    ...
    public static int dip2px(float dipValue) {
        return dip2px(BaseApplication.get(), dipValue);
    }
    ...
    public static float getDensityValue() {
        return getDensityValue(BaseApplication.get());
    }
    ...
    public static float getDmDensityDpi() {
        return getDmDensityDpi(BaseApplication.get());
    }
    ...
    public static String getImeiValue() {
        ...
        try {
            deviceId = ((TelephonyManager) BaseApplication.get().getSystemService(Context.TELEPHONY_SERVICE))
                    .getDeviceId();
    ...
    public static String getMacValue() {
        ...
        try {
            ...
            WifiManager wifi = (WifiManager) BaseApplication.get().getSystemService(Context.WIFI_SERVICE);
    ...
    public static String getDeviceId() {
        ...
        if (TextUtils.isEmpty(deviceId)) {
            ...
            if (TextUtils.isEmpty(deviceId)) {
                ...
                deviceId = Settings.Secure.getString(BaseApplication.get().getContentResolver(), Settings.Secure.ANDROID_ID);
            }
        }
    ...
    public static int getScreenHeight() {
        return getScreenHeight(BaseApplication.get());
    }
    ...
    public static int getScreenWidth() {
        return getScreenWidth(BaseApplication.get());
    }
    ...
    public static int px2dip(float pxValue) {
        return px2dip(BaseApplication.get(), pxValue);
    }
